...
## Installation recipe for era 2018 UL
...
!!! Installation not fully available yet !!!

### SetUp the Gamma + Jet frame work and compile
```
cd $CMSSW_BASE/src
git clone -o lucas git@github.com:lucastorterotot/DijetRootTreeMaker.git -b JEC_JER_2018UL_CMSSW_10_6_3_master CMSDIJET/DijetRootTreeMaker/
scram b -j 8
```
