...
config.General.requestName = 'GJet-ReReco-Run2016C_v2'
...
config.Data.inputDataset = '/SinglePhoton/Run2016C-23Sep2016-v1/MINIAOD'
...
config.Data.outLFNDirBase = '/store/group/phys_jetmet/hlattaud/GammaJet/GJet-ReReco-Run2016C'
